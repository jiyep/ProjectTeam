<%@page import="cs.dit.dto.westfood_ContentDto"%>
<%@page import="cs.dit.dao.westfood_ContentDao"%>
    ...
    <section class="main">
        <div class="container">
            <div class="row">
                ...
                <center>
                <button onclick="location.href='makeContent_west.do'" class="btn btn-primary pull-right" style="border: 1px solid;" margin-left="80%">글쓰기</button>
                </center>
            </div>
        </div>
    </section>
