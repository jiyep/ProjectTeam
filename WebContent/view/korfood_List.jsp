...
<%@page import="cs.dit.dao.korfood_ContentDao" %>
<%@page import="cs.dit.dto.korfood_ContentDto" %>
    ...
    <section class="main">
        <div class="container">
            <div class="row">
                    ...
                    <tbody>
                    	<c:forEach var='dto' items='${dtos}'>
                        	<tr>
                            	...
                            	<td style="background-color: white;" >${dto.id }</td> <!-- 세션에서 ID들고와서 세팅 -->
                ...
                <center>
                <button onclick="location.href='makeContent_kor.do'" class="btn btn-primary pull-right" style="border: 1px solid;" margin-left="80%">글쓰기</button>
                </center>
            </div>
        </div>
    </section>
